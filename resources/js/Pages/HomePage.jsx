...
function HomePage() {
    ...
    const [isUpcomingTripAvailable, setIsUpcomingTripAvailable] = useState(false);
    ...
    useLayoutEffect(() => {
        ...
        checkIsCardDataEmpty(todayCardProp, setTodayTripCardProp, setIsTripsAvailable);
    ...
    return (
        <div className="lg:max-w-[400px] md:min-w-[360px] mx-auto">
            ...
            <div className="px-5 mb-20 bg-white">
                <div className="font-semibold text-black">Popular Destinations</div>
                <CarouselDashboard />
                <div className="font-semibold text-black mb-5">Today's Trip</div>
                {isTripAvailable ? (
                    <CardComponent CardProp={todayTripCardProp} />
                ) : (
                    <div>none</div>
                )}
                <div className="font-semibold text-orange my-5">Upcoming's Trip</div>
